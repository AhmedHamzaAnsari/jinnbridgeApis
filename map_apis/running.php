...
if (isset($_GET['accesskey'])) {
	...
	if ($access_key_received == $access_key) {
		...
		$sql_query = "SELECT * FROM devicesnew as pos join users_devices_new ud on pos.id = ud.devices_id where pos.speed > 0 and pos.speed < 50 $cls and pos.ignition ='ON' and pos.time >='$prev_date' order by time desc";
