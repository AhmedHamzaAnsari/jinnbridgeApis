...
$Select3 = "SELECT id FROM Jinn.positions order by id asc limit 1";
...
$uniqueb2 = intval($bbunique)+'1';
	...
	elseif($protocol == 'tw_Jinn' || $protocol == 'al_shyma' || $protocol == 'Universal' || $protocol == 'topflay' || $protocol == 'anytracker' || $protocol == 'TPL' || $protocol == 'PTSL' || $protocol == 'tellogix' || $protocol == 'xtream' || $protocol == 'teltonika' || $protocol == 'iot'){
...
if($protocol != 'tw_Jinn' && $protocol != 'al_shyma' && $protocol != 'Universal' && $protocol != 'topflay' && $protocol != 'anytracker' && $protocol != 'resq911'&& $protocol != 'TPL' && $protocol != 'PTSL' && $protocol != 'tellogix' && $protocol != 'xtream' && $protocol != 'teltonika' && $protocol != 'iot'){
...
if($exe_Select2 == true && $pdivice_id != null){
	$insert_positions = "INSERT into Jinn.positions(address,altitude,course,latitude,longitude,other,power,speed,time,valid,device_id,AlarmStatus,imileage,ikey,ireason,ireasoncode,syscode,vehicle_id,dtype,chk1,vlocation,overspeed,record_creation_time, recorddate)
	...
	$Select4 = "SELECT id FROM Jinn.positions where device_id='$pdivice_id' order by time desc limit 1";
